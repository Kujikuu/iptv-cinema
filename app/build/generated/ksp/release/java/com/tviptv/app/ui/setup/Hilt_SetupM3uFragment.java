...
public abstract class Hilt_SetupM3uFragment extends GuidedStepSupportFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SetupM3uFragment_GeneratedInjector) this.generatedComponent()).injectSetupM3uFragment(UnsafeCasts.<SetupM3uFragment>unsafeCast(this));
    }
  }
