...
public abstract class Hilt_SeriesDetailsFragment extends RowsSupportFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SeriesDetailsFragment_GeneratedInjector) this.generatedComponent()).injectSeriesDetailsFragment(UnsafeCasts.<SeriesDetailsFragment>unsafeCast(this));
    }
  }
