...
public abstract class Hilt_ChannelDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ChannelDetailsFragment() {
    super();
  }

  Hilt_ChannelDetailsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChannelDetailsFragment_GeneratedInjector) this.generatedComponent()).injectChannelDetailsFragment(UnsafeCasts.<ChannelDetailsFragment>unsafeCast(this));
    }
  }
