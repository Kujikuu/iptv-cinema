...
public abstract class Hilt_LauncherHomeFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LauncherHomeFragment() {
    super();
  }

  Hilt_LauncherHomeFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LauncherHomeFragment_GeneratedInjector) this.generatedComponent()).injectLauncherHomeFragment(UnsafeCasts.<LauncherHomeFragment>unsafeCast(this));
    }
  }
