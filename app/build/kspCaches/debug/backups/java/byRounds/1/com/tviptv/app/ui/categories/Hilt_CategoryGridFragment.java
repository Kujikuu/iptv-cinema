...
public abstract class Hilt_CategoryGridFragment extends RowsSupportFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CategoryGridFragment_GeneratedInjector) this.generatedComponent()).injectCategoryGridFragment(UnsafeCasts.<CategoryGridFragment>unsafeCast(this));
    }
  }
