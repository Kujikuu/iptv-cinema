...
public abstract class Hilt_SetupM3uFileFragment extends GuidedStepSupportFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SetupM3uFileFragment_GeneratedInjector) this.generatedComponent()).injectSetupM3uFileFragment(UnsafeCasts.<SetupM3uFileFragment>unsafeCast(this));
    }
  }
