...
public abstract class Hilt_SetupXtreamFragment extends GuidedStepSupportFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SetupXtreamFragment_GeneratedInjector) this.generatedComponent()).injectSetupXtreamFragment(UnsafeCasts.<SetupXtreamFragment>unsafeCast(this));
    }
  }
