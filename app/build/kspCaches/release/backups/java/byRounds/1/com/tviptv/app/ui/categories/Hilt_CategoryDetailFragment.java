...
public abstract class Hilt_CategoryDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CategoryDetailFragment() {
    super();
  }

  Hilt_CategoryDetailFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CategoryDetailFragment_GeneratedInjector) this.generatedComponent()).injectCategoryDetailFragment(UnsafeCasts.<CategoryDetailFragment>unsafeCast(this));
    }
  }
