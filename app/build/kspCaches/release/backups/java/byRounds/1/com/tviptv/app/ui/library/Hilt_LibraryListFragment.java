...
public abstract class Hilt_LibraryListFragment extends VerticalGridSupportFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LibraryListFragment_GeneratedInjector) this.generatedComponent()).injectLibraryListFragment(UnsafeCasts.<LibraryListFragment>unsafeCast(this));
    }
  }
