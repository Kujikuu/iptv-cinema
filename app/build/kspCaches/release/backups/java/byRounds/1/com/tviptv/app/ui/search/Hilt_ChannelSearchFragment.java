...
public abstract class Hilt_ChannelSearchFragment extends SearchSupportFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChannelSearchFragment_GeneratedInjector) this.generatedComponent()).injectChannelSearchFragment(UnsafeCasts.<ChannelSearchFragment>unsafeCast(this));
    }
  }
