...
class StreamingRowPresenter : ListRowPresenter() {
    ...
    override fun initializeRowViewHolder(holder: RowPresenter.ViewHolder) {
        ...
        rowViewHolder.gridView.horizontalSpacing =
            rowViewHolder.view.resources.getDimensionPixelSize(com.tviptv.app.R.dimen.row_item_spacing)
        rowViewHolder.gridView.setPadding(
            rowViewHolder.view.resources.getDimensionPixelSize(com.tviptv.app.R.dimen.row_padding_horizontal),
