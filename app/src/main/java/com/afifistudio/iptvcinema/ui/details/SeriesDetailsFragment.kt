...
import com.afifistudio.iptvcinema.ui.browse.HeroCardPresenter
...
class SeriesDetailsFragment : RowsSupportFragment() {
    ...
    private fun buildSeasonRow(
        ...
        continueWatchingByEpisodeId: Map<String, com.afifistudio.iptvcinema.domain.model.ContinueWatchingItem>,
    ): ListRow {
